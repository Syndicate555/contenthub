          ...
          <div className="grid gap-6 rounded-[22px] bg-white/90 p-6 sm:grid-cols-2">
            <div className="space-y-3">
              ...
              <p className="text-gray-600">
                Every save and review moves you forward. Domains track your
                specialties, streaks keep you consistent, and badges celebrate
                milestones.
              </p>
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-2xl bg-gray-50/80 p-4 shadow-inner">
                  ...
                  <p className="text-xs text-gray-600">
                    Don&apos;t break the chain—earn +10 XP daily.
                  </p>
                </div>
              </div>
            </div>
