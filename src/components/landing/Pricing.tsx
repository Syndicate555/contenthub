        ...
        <div className="text-center mb-16">
          ...
          <Reveal delay={0.2}>
            <p className="text-lg text-text-secondary max-w-2xl mx-auto">
              We&apos;re building Tavlo with early users. Join now and help shape the product while getting free access.
            </p>
          </Reveal>
        </div>
            ...
            <div className="relative bg-surface-solid rounded-[1.5rem] border border-brand-1/20 shadow-xl overflow-hidden">
              <div className="p-8 md:p-10">
                <div className="flex items-center justify-between mb-2">
                  <h3 className="text-lg font-semibold text-text-primary">Beta Program</h3>
                ...
                <div className="flex items-baseline gap-1 mb-6">
                  ...
                  <span className="text-text-muted">/ forever for beta users</span>
                </div>
                
                <p className="text-sm text-text-secondary mb-8">
                  Everything you need to organize your saves. No credit card. No catch.
                </p>
